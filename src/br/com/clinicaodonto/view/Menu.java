        ...
        btnMostrarDentista.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
            	...
            	try {
            		...
            		mostrar.consultar(txtMatriculaDentista.getText());
            		txtCroDentista.setText(mostrar.dentistas.getCro());
            		//txtCategoriaDentista.setText(mostrar.dentistas.getCro());
            		txtNomeDentista.setText(mostrar.dentistas.getNome());
            		txtNascimentoDentista.setText(mostrar.dentistas.getNascimento());
            		cmbSexoDentista.setSelectedItem(mostrar.dentistas.getSexo());
                	txtRgDentista.setText(mostrar.dentistas.getRg());
            		txtCpfDentista.setText(mostrar.dentistas.getCpf());
            		txtEmailDentista.setText(mostrar.dentistas.getEmail());
            		txtEnderecoDentista.setText(mostrar.dentistas.getEndereco());
            		txtMunicipioDentista.setText(mostrar.dentistas.getMunicipio());
            		txtCepDentista.setText(mostrar.dentistas.getCep());
            		txtTelDentista.setText(mostrar.dentistas.getCelular());
        ...
        btnAtualizarFuncionario.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
            	...
            	try {
            		...
            		DentistasDAO mostrar = new DentistasDAO();
            		mostrar.consultar(txtMatriculaFuncionario.getText());
            		//txtCategoriaFuncionario.setText(mostrar.dentistas.getCro());
            		txtNomeFuncionario.setText(mostrar.dentistas.getNome());
            		txtNascimentoFuncionario.setText(mostrar.dentistas.getNascimento());
            		cmbSexoFuncionario.setSelectedItem(mostrar.dentistas.getSexo());
                	txtRgFuncionario.setText(mostrar.dentistas.getRg());
            		txtCpfFuncionario.setText(mostrar.dentistas.getCpf());
            		txtEmailFuncionario.setText(mostrar.dentistas.getEmail());
            		txtEnderecoFuncionario.setText(mostrar.dentistas.getEndereco());
            		txtMunicipioFuncionario.setText(mostrar.dentistas.getMunicipio());
            		txtCepFuncionario.setText(mostrar.dentistas.getCep());
            		txtTelFuncionario.setText(mostrar.dentistas.getCelular());
